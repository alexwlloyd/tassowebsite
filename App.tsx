    ...
    <Section id="about" title="Chi Siamo">
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            ...
            <div className="md:w-1/2 text-lg text-zinc-300 space-y-4 text-center md:text-left">
                <p>
Alex, Gaia e Zeno sono i tassi. Il tasso è l'animale profondo che cerca radici e si pianta saldo nel terreno.                </p>
                <p>
Il nostro piccolo progetto di fattoria familiare nasce da questi valori. Vogliamo ispirare l'offerta di verdure naturali, sane e locali utilizzando metodi che vanno oltre il tipico biologico.                </p>
                <p>
Crediamo che le piccole aziende agricole familiari e le vendite dirette locali come una delle azioni più significative e dirette per affrontare molti dei problemi che affrontiamo nel mondo di oggi. Valorizziamo il buon cibo al centro delle nostre vite e abbiamo scelto di dedicarci a esso.       </p>     </div>
        </div>
    </Section>
);
...
Tutte le nostre verdure sono coltivate in modo completamente naturale, senza l'uso di macchine alimentate a combustibili fossili e solo con compost biologico di provenienza locale. I prezzi sono determinati a seguito di intense ricerche locali e nazionali. Siamo determinati a offrire i prezzi più popolari e realistici possibili, ma riconosciamo anche il duro lavoro dei nostri colleghi agricoltori locali e non cerchiamo di competere svendendo e minando le organizzazioni locali con cui siamo associati, come la rete microfarm italiana.                    </p>
...
Consegnamo ogni settimana scatole personalizzate dei nostri ortaggi naturali e biologici coltivati in casa entro un raggio di 15 km dalla nostra abitazione, utilizzando la nostra umile Panda del 1995. Tutti gli ordini vengono effettuati tramite messaggi diretti su WhatsApp. Contattaci per maggiori dettagli.            </p>
      {/* Embedded Google Sheet for Ordina section */}
      <div className="mb-8 flex justify-center">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRp6mNCseP6_dEwsozYxJ6qQr0wfgOPjIosyb-LWgi-neVqI-fynIzvzGPKqAlc-YiDQltRgLspnWGV/pubhtml?gid=1565692743&single=true"
