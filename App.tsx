...
const Hero: React.FC = () => (
    <section id="home" className="relative h-[60vh] md:h-[80vh] min-h-[400px] flex items-center justify-center text-center text-white bg-cover bg-center" style={{backgroundImage: "url('/images/hero.jpg')"}}>
        <div className="absolute inset-0 bg-black/60"></div>
        <div className="relative z-10 p-4">
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-display text-yellow-400 drop-shadow-lg">Il Tasso</h1>
            <p className="mt-4 text-xl md:text-2xl max-w-2xl mx-auto text-zinc-200">Prodotti genuini, dalla nostra terra alla vostra tavola.</p>
            <div className="mt-8">
    ...
    <Section id="about" title="Chi Siamo">
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            <div className="md:w-1/2">
                <img src="/images/farmers.jpg" alt="I contadini de Il Tasso" className="rounded-full w-64 h-64 md:w-96 md:h-96 object-cover mx-auto border-4 border-yellow-400 shadow-xl" />
            </div>
        ...
        <div className="max-w-5xl mx-auto">
            <div className="bg-zinc-800 rounded-lg overflow-hidden shadow-lg border border-zinc-700">
                <img 
                    ...
                    alt="Catalogo Prodotti de Il Tasso" 
                />
        ...
        <div className="max-w-4xl mx-auto text-center text-zinc-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-lg">
                <div className="bg-zinc-800 p-6 rounded-lg border border-zinc-700">
                    ...
                    <p>Via della Campagna, 42</p>
                    <p>01010, Borgo Rurale (VT), Italia</p>
                </div>
                <div className="bg-zinc-800 p-6 rounded-lg border border-zinc-700">
                ...
                <div className="bg-zinc-800 p-6 rounded-lg border border-zinc-700">
                    ...
                    <p>info@iltassofarm.it</p>
                    <p>ordini@iltassofarm.it</p>
                </div>
            </div>
        </div>
    </Section>
...
const Footer: React.FC = () => (
    <footer className="bg-zinc-900 border-t border-zinc-700">
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 text-center text-zinc-400">
            ...
            <p>&copy; {new Date().getFullYear()} Azienda Agricola IL TASSO. Tutti i diritti riservati.</p>
        </div>
    </footer>
);
